...
bool CSmallString::operator==(const char* aCharArray)
{
...
void CSmallString::operator=(const char* aCharArray)
{
...
CSmallString CSmallString::operator+(const char* aCharArray)
{
	CSmallString rv = *this;
...
std::string CSmallString::ToString()
{
